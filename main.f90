...
! TIMING
  ...
  do I = first_model, last_model
    ...
    read(20,*) model_number, ra, rb, rc, initial_model_type, rhom1, rhom2, pin, frac
    print*, "read  model_number, ra, rb, rc, initial_model_type, rhom1, rhom2, pin, frac from file init"
    call binary_initialize(rhom1, rhom2, ra, rb, rc, phia, phib, phic, &
                            za,  zb, zc, initial_model_type)
    print*, "finished binary initialize"
    call binary_scf(model_number, initial_model_type, ra, rb, rc, rhom1, rhom2, frac, &
                   pin, eps,  qfinal)
    print*, "finished binary_scf"
